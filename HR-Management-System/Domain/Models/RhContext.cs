...
public partial class RhContext : DbContext
{
    ...
    {
        // Esta verificação é crucial para os testes. 
        // Se o optionsBuilder já foi configurado (pelo InMemory no teste), ele não tenta usar o Npgsql.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Cpf).HasMaxLength(14).HasColumnName("cpf");
        ...
        modelBuilder.Entity<Training>(entity =>
        {
            ...
            entity.Property(e => e.Topic).HasMaxLength(150).HasColumnName("topic");
        });
